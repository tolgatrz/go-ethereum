...
type ContractRef interface {
	...
	Value() *big.Int
	SetCode([]byte)
	ForEachStorage(full bool, callback func(key, value common.Hash) bool)
}
...
// value pair.
func (self *Contract) ForEachStorage(full bool, cb func(key, value common.Hash) bool) {
	self.caller.ForEachStorage(full, cb)
}
